...
activities = {
    ...
    "Drama Society": {
        "description": "Practice acting, stagecraft, and put on student theater productions",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["harper@mergington.edu", "mason@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science and engineering competitions with hands-on challenges",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["sophia@mergington.edu", "noah@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking and argumentation skills through debate practice",
